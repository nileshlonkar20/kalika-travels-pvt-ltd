export const metadata = {
  title: "Terms and Conditions | Kalika Travels",
  description: "Terms and conditions for Kalika Travels vehicle rentals and trip bookings.",
}
    ...
    <main className="min-h-screen bg-background px-4 py-12 sm:px-6 sm:py-20">
      <article className="mx-auto max-w-3xl">
        ...
        <div className="mt-10 space-y-8 leading-relaxed text-muted-foreground">
          <section><h2 className="font-heading text-xl font-bold text-foreground">Bookings</h2><p className="mt-3">A booking is confirmed after vehicle availability, trip details and pricing are agreed with Kalika Travels. Quotes may change when dates, route, vehicle or passenger requirements change.</p></section>
