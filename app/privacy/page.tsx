export const metadata = {
  title: "Privacy Policy | Kalika Travels",
  description: "Privacy policy for Kalika Travels enquiries and bookings.",
}
    ...
    <main className="min-h-screen bg-background px-4 py-12 sm:px-6 sm:py-20">
      <article className="mx-auto max-w-3xl">
        ...
        <div className="mt-10 space-y-8 leading-relaxed text-muted-foreground">
          <section><h2 className="font-heading text-xl font-bold text-foreground">Information we collect</h2><p className="mt-3">When you submit an enquiry, we collect the name, phone number, email address and trip details you provide so Kalika Travels can respond to your request.</p></section>
