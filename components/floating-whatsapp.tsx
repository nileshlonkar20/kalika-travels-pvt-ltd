...
export function FloatingWhatsApp() {
  return (
    <a
      href={`${contact.whatsappHref}?text=${encodeURIComponent("Hello Kalika Translink, I would like to enquire about a vehicle.")}`}
      target="_blank"
      rel="noreferrer"
      aria-label="Chat with Kalika Translink on WhatsApp"
